    ...
    <>
      ...
      {isDemo && (
        <div style={{ background: '#2d1f00', borderBottom: '1px solid #5c3d00', padding: '.625rem 2rem', display: 'flex', alignItems: 'center', gap: '.75rem' }}>
          ...
          <span style={{ color: '#7a5000', fontSize: '.75rem' }}>
      ...
      {loading ? (
        ...
        <div style={{ padding: '4rem', textAlign: 'center' }}>
          <p style={{ color: '#333', fontSize: '.8rem', marginBottom: '.5rem' }}>No leads found.</p>
          {leads.length === 0 && !isDemo && (
            <p style={{ color: '#222', fontSize: '.75rem' }}>Leads submitted to {coach.firstName} will appear here.</p>
          )}
        </div>
      ) : (
