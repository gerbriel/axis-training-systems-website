    ...
    <div style={{ padding: '2rem', maxWidth: 800 }}>
      ...
      {contentType === 'blog' && (
        <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: '.25rem', padding: '2rem', marginBottom: '2rem' }}>
          <p style={{ color: 'var(--text)', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.3em', textTransform: 'uppercase', marginBottom: '1.5rem' }}>New Blog Post</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              {submitError && <span style={{ color: 'var(--text)', fontSize: '.75rem', fontWeight: 700 }}>{submitError}</span>}
            </div>
          </div>
        </div>
      )}
      ...
      {contentType === 'meet' && (
        <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: '.25rem', padding: '2rem', marginBottom: '2rem' }}>
          <p style={{ color: 'var(--text)', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.3em', textTransform: 'uppercase', marginBottom: '1.5rem' }}>Add Meet / Event</p>
