  ...
  return (
    <div style={{ background: '#10131a', minHeight: '100vh' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(16,19,26,0.95)', backdropFilter: 'blur(8px)', borderBottom: '1px solid #112038', padding: '0 2rem', display: 'flex', alignItems: 'center', height: '3.5rem', gap: '1.5rem' }}>
        ...
        <span style={{ color: '#1c3255', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.2em', textTransform: 'uppercase' }}>Coaches</span>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: '1rem', alignItems: 'center' }}>
          ...
          <a
            ...
            style={{ background: '#c8102e', color: '#fff', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.15em', textTransform: 'uppercase', padding: '.4rem 1rem', borderRadius: '.2rem', textDecoration: 'none', transition: 'background .15s' }}
      ...
      {/* ── Hero ─────────────────────────────────────────────────────────── */}
      <section style={{ padding: '6rem 2rem 4rem', borderBottom: '1px solid #0d2040' }}>
            ...
            <div style={{ flexShrink: 0 }}>
              {coach.photo ? (
                <img
                  ...
                  style={{ width: 140, height: 140, borderRadius: '50%', objectFit: 'cover', border: '3px solid #152842' }}
                />
              ) : (
                <div style={{ width: 120, height: 120, borderRadius: '50%', background: '#0d2040', border: '2px solid #152842', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ color: '#c8102e', fontWeight: 900, fontSize: '3rem' }}>{coach.firstName[0]}</span>
                </div>
              )}
            </div>
            {/* Name + role */}
            <div style={{ flex: 1, minWidth: 260 }}>
              <p style={{ color: '#c8102e', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '.5rem' }}>{coach.role}</p>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '.75rem' }}>
                <a
                  href={applyHref(coach.slug)}
                  style={{ background: '#c8102e', color: '#fff', fontWeight: 900, fontSize: '.75rem', letterSpacing: '.2em', textTransform: 'uppercase', padding: '.875rem 2rem', borderRadius: '.25rem', textDecoration: 'none', transition: 'background .15s' }}
                  onMouseEnter={e => e.currentTarget.style.background = '#a30c26'}
                  onMouseLeave={e => e.currentTarget.style.background = '#c8102e'}
                >
      ...
      {/* ── Stats bar ────────────────────────────────────────────────────── */}
      <section style={{ borderBottom: '1px solid #0d2040', background: '#10131a' }}>
        <div style={{ maxWidth: 960, margin: '0 auto', padding: '0 2rem', display: 'flex', flexWrap: 'wrap' }}>
          {coach.stats.map((s, i) => (
            <div key={i} style={{ flex: '1 1 120px', padding: '2rem 1.5rem', borderRight: i < coach.stats.length - 1 ? '1px solid #0a1f3c' : 'none' }}>
      ...
      {/* ── Bio ──────────────────────────────────────────────────────────── */}
      <section style={{ padding: '5rem 2rem', borderBottom: '1px solid #0a1f3c' }}>
        <div style={{ maxWidth: 960, margin: '0 auto', display: 'grid', gap: '3rem', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
          <div>
            <p style={{ color: '#c8102e', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '1.5rem' }}>About</p>
          ...
          <div>
            ...
            <p style={{ color: '#c8102e', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '1.5rem' }}>Coaching Philosophy</p>
            <blockquote style={{ borderLeft: '3px solid #c8102e', paddingLeft: '1.5rem', marginBottom: '2.5rem' }}>
              <p style={{ color: '#fff', fontSize: '1.1rem', fontWeight: 700, lineHeight: 1.6, fontStyle: 'italic' }}>"{coach.coachingPhilosophy}"</p>
            </blockquote>
            {/* Specialties */}
            <p style={{ color: '#c8102e', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '1rem' }}>Specialties</p>
      ...
      {/* ── Services ─────────────────────────────────────────────────────── */}
      <section style={{ padding: '5rem 2rem', background: '#10131a', borderBottom: '1px solid #0a1f3c' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <p style={{ color: '#c8102e', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '.75rem' }}>Services</p>
          ...
          <div style={{ display: 'grid', gap: '1.5rem', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
            {coach.services.map((s, i) => (
              <div key={i} style={{ background: '#0c1827', border: '1px solid #112038', padding: '2rem', borderRadius: '.25rem', display: 'flex', flexDirection: 'column', gap: '.75rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', flexWrap: 'wrap' }}>
                  <p style={{ color: '#fff', fontWeight: 900, fontSize: '.9rem', textTransform: 'uppercase', letterSpacing: '.05em' }}>{s.name}</p>
                  <span style={{ color: '#c8102e', fontWeight: 900, fontSize: '.875rem', whiteSpace: 'nowrap' }}>{s.price}</span>
                </div>
                <p style={{ color: '#555', fontSize: '.85rem', lineHeight: 1.7 }}>{s.description}</p>
                <a
                  href={applyHref(coach.slug)}
                  style={{ marginTop: 'auto', display: 'inline-block', background: 'transparent', border: '1px solid #243650', color: '#888', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.15em', textTransform: 'uppercase', padding: '.6rem 1.25rem', borderRadius: '.2rem', textDecoration: 'none', transition: 'border-color .15s, color .15s', alignSelf: 'flex-start' }}
      ...
      <section style={{ padding: '5rem 2rem', borderBottom: '1px solid #0a1f3c' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <p style={{ color: '#c8102e', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '.75rem' }}>Results</p>
          <h2 style={{ color: '#fff', fontWeight: 900, fontSize: 'clamp(1.75rem, 4vw, 3rem)', textTransform: 'uppercase', letterSpacing: '-.02em', marginBottom: '3rem' }}>
            Athlete Outcomes
          </h2>
          <div style={{ display: 'grid', gap: '1.5rem', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))' }}>
            {coach.testimonials.map((t, i) => (
              <div key={i} style={{ background: '#0c1827', border: '1px solid #112038', padding: '2rem', borderRadius: '.25rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {/* Quote mark */}
                <span style={{ color: '#c8102e', fontSize: '2rem', fontWeight: 900, lineHeight: 1, opacity: .6 }}>"</span>
                <p style={{ color: '#aaa', fontSize: '.875rem', lineHeight: 1.8, flex: 1 }}>{t.quote}</p>
                <div style={{ borderTop: '1px solid #0d2040', paddingTop: '1rem', display: 'flex', alignItems: 'center', gap: '.875rem' }}>
                  {t.photo ? (
                    <img
                      src={t.photo}
                      alt={t.athlete}
                      style={{ width: 42, height: 42, borderRadius: '50%', objectFit: 'cover', flexShrink: 0, border: '2px solid #152842' }}
                    />
                  ) : (
                    <div style={{ width: 42, height: 42, borderRadius: '50%', background: '#0d2040', border: '2px solid #152842', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <span style={{ color: '#c8102e', fontWeight: 900, fontSize: '1rem' }}>{t.athlete[0]}</span>
                    </div>
                  )}
                  <div>
                    <p style={{ color: '#fff', fontWeight: 700, fontSize: '.8rem', marginBottom: '.2rem' }}>{t.athlete}</p>
                    <p style={{ color: '#c8102e', fontSize: '.6rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase' }}>{t.result}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section style={{ position: 'relative', padding: '7rem 2rem', overflow: 'hidden' }}>
        ...
        {/* Dark overlay */}
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(10,31,60,0.55) 0%, rgba(10,31,60,0.75) 60%, rgba(10,31,60,0.95) 100%)', pointerEvents: 'none' }} />
        <div style={{ position: 'relative', maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <p style={{ color: '#c8102e', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '1rem' }}>Ready to Start?</p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '.75rem', justifyContent: 'center' }}>
            <a
              href={applyHref(coach.slug)}
              style={{ display: 'inline-block', background: '#c8102e', color: '#fff', fontWeight: 900, fontSize: '.8rem', letterSpacing: '.2em', textTransform: 'uppercase', padding: '1.125rem 2.5rem', borderRadius: '.25rem', textDecoration: 'none', transition: 'background .15s' }}
              onMouseEnter={e => e.currentTarget.style.background = '#a30c26'}
              onMouseLeave={e => e.currentTarget.style.background = '#c8102e'}
            >
      ...
      <div style={{ background: '#10131a', borderTop: '1px solid #0a1f3c', padding: '1.5rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
          ...
          <a href={adminHref(coach.slug)} style={{ color: '#1c3255', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.15em', textTransform: 'uppercase', textDecoration: 'none' }}>Coach Admin</a>
        </div>
      </div>
    </div>
  )
