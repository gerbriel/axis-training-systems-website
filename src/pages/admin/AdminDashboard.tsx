  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div style={{ padding: '4rem', textAlign: 'center', color: 'var(--text-3)', fontSize: '.8rem' }}>No leads found.</div>
      ) : (
            ...
            <tbody>
              {filtered.map(lead => (
                ...
                >
                  ...
                  <td style={{ padding: '1rem 1.25rem', color: 'var(--text-2)', whiteSpace: 'nowrap' }}>{lead.coach_pref}</td>
