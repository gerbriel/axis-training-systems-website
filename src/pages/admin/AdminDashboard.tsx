  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div style={{ padding: '4rem', textAlign: 'center', color: '#888888', fontSize: '.8rem' }}>No leads found.</div>
      ) : (
            ...
            <tbody>
              {filtered.map(lead => (
                ...
                >
                  ...
                  <td style={{ padding: '1rem 1.25rem', color: '#c7c7c7', whiteSpace: 'nowrap' }}>{lead.coach_pref}</td>
