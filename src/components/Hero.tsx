...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden" style={{ background: '#10131a' }}>
      {/* Grid overlay */}
      <div
      ...
      <div
        ...
        style={{ top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 700, height: 450, background: '#c8102e', opacity: 0.04, filter: 'blur(140px)', borderRadius: '50%' }}
      />

      <div className="relative max-w-7xl mx-auto px-6" style={{ paddingTop: '9rem', paddingBottom: '6rem' }}>
        {/* Eyebrow */}
        <p style={{ color: '#c8102e', fontSize: '.7rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '2rem' }}>
        ...
        <h1 style={{ fontWeight: 900, lineHeight: 0.88, letterSpacing: '-.03em', marginBottom: '2rem' }}>
          ...
          <span style={{ display: 'block', fontSize: 'clamp(3.5rem,10vw,9.5rem)', textTransform: 'uppercase', color: '#c8102e' }}>Training.</span>
        </h1>
        ...
        {/* Stats */}
        <div className="flex flex-wrap gap-x-14 gap-y-8 mt-20 pt-10" style={{ borderTop: '1px solid #112038' }}>
          {STATS.map(s => (
            <div key={s.label}>
      ...
      {/* Scroll cue */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2" style={{ color: '#243650' }}>
