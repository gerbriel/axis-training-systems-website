...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div style={{ marginBottom: '2.5rem' }}>
    <h3 style={{ color: '#fff', fontWeight: 800, fontSize: '1rem', textTransform: 'uppercase', letterSpacing: '.05em', marginBottom: '1rem', borderBottom: '1px solid #222222', paddingBottom: '.75rem' }}>
      {title}
    </h3>
    <div style={{ color: '#c7c7c7', fontSize: '.875rem', lineHeight: 1.8 }}>
      {children}
    </div>
  </div>
)
...
export default function PrivacyPolicy({ onClose }: Props) {
  return (
    <div
      ...
      style={{ background: 'rgba(0,0,0,0.90)', backdropFilter: 'blur(4px)', padding: '2rem 1rem' }}
      onClick={e => { if (e.target === e.currentTarget) onClose() }}
    >
      <div
        className="relative w-full max-w-3xl"
        style={{ background: '#000000', border: '1px solid #222222', borderRadius: '.25rem', padding: '3rem 2.5rem' }}
      >
        {/* Close */}
        <button
          onClick={onClose}
        ...
        {/* Header */}
        <p style={{ color: '#fff', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '1rem' }}>Legal</p>
        ...
        <p style={{ color: '#c7c7c7', fontSize: '.8rem', marginBottom: '2.5rem' }}>
        ...
        <Section title="1. Who We Are">
          ...
          <p style={{ marginTop: '.75rem', color: '#888888' }}>
            Email: <a href="mailto:coach@axistrainingsystems.com" style={{ color: '#fff' }}>coach@axistrainingsystems.com</a><br />
            Instagram: <a href="https://www.instagram.com/axistrainingsystems/" target="_blank" rel="noopener" style={{ color: '#fff' }}>@axistrainingsystems</a>
          </p>
        </Section>
        ...
        <Section title="4. Tracking Technologies, Advertising & Analytics">
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            <Li><strong style={{ color: '#aaa' }}>Meta Pixel (Facebook/Instagram Pixel)</strong> — We use the Meta Pixel to track website events (page views, form submissions) and to build custom audiences for retargeting ads on Facebook and Instagram. Meta may use this data in accordance with its{' '}<a href="https://www.facebook.com/privacy/policy/" target="_blank" rel="noopener" style={{ color: '#fff' }}>Data Policy</a>.</Li>
            <Li><strong style={{ color: '#aaa' }}>Google Ads & Google Analytics</strong> — We use Google Ads conversion tracking and remarketing tags (via Google Tag Manager) to measure ad performance and serve retargeting ads across Google Search, YouTube, and the Google Display Network. Governed by{' '}<a href="https://policies.google.com/privacy" target="_blank" rel="noopener" style={{ color: '#fff' }}>Google's Privacy Policy</a>.</Li>
          ...
          <p style={{ marginTop: '.75rem' }}>
            ...
            <a href="https://www.facebook.com/settings/?tab=ads" target="_blank" rel="noopener" style={{ color: '#fff' }}>Meta Ad Preferences</a>
            {' · '}
            <a href="https://adssettings.google.com/" target="_blank" rel="noopener" style={{ color: '#fff' }}>Google Ad Settings</a>
            {' · '}
            <a href="https://optout.aboutads.info/" target="_blank" rel="noopener" style={{ color: '#fff' }}>DAA Opt-Out</a>
          </p>
          <p style={{ marginTop: '.75rem' }}>
            ...
            <a href="https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement" target="_blank" rel="noopener" style={{ color: '#fff' }}>GitHub's Privacy Statement</a>.
          </p>
          <p style={{ marginTop: '.75rem' }}>
        ...
        <Section title="5. How We Share Your Information">
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            <Li><strong style={{ color: '#aaa' }}>Meta Platforms, Inc.</strong> — website visitor event data is shared with Meta via the Meta Pixel for ad measurement and retargeting. Subject to{' '}<a href="https://www.facebook.com/privacy/policy/" target="_blank" rel="noopener" style={{ color: '#fff' }}>Meta's Data Policy</a>.</Li>
            <Li><strong style={{ color: '#aaa' }}>Google LLC</strong> — website visitor event data is shared with Google via Google Ads tags for conversion tracking and remarketing. Subject to{' '}<a href="https://policies.google.com/privacy" target="_blank" rel="noopener" style={{ color: '#fff' }}>Google's Privacy Policy</a>.</Li>
        ...
        <Section title="6. California Privacy Rights (CCPA / CPRA)">
          ...
          <p style={{ marginTop: '.75rem' }}>
            ...
            <a href="mailto:coach@axistrainingsystems.com" style={{ color: '#fff' }}>coach@axistrainingsystems.com</a>.
