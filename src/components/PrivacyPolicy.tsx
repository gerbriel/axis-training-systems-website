...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div style={{ marginBottom: '2.5rem' }}>
    <h3 style={{ color: 'var(--text)', fontWeight: 800, fontSize: '1rem', textTransform: 'uppercase', letterSpacing: '.05em', marginBottom: '1rem', borderBottom: '1px solid var(--border)', paddingBottom: '.75rem' }}>
      {title}
    </h3>
    <div style={{ color: 'var(--text-2)', fontSize: '.875rem', lineHeight: 1.8 }}>
      {children}
    </div>
  </div>
)
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: '.25rem', padding: '3rem 2.5rem' }}
      >
        {/* Close */}
        <button
          onClick={onClose}
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '.25rem', color: 'var(--text)' }}
        >
        ...
        {/* Header */}
        <p style={{ color: 'var(--text)', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '1rem' }}>Legal</p>
        <h2 style={{ color: 'var(--text)', fontWeight: 900, fontSize: 'clamp(1.5rem,4vw,2.5rem)', textTransform: 'uppercase', letterSpacing: '-.02em', marginBottom: '.75rem' }}>Privacy Policy</h2>
        <p style={{ color: 'var(--text-2)', fontSize: '.8rem', marginBottom: '2.5rem' }}>
        ...
        <Section title="4. Tracking Technologies, Advertising & Analytics">
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            ...
            <Li><strong style={{ color: 'var(--text-dim)' }}>Email marketing tracking</strong> — We do not currently use marketing automation platforms that track email open rates or click behaviour.</Li>
          </ul>
        ...
        <Section title="6. California Privacy Rights (CCPA / CPRA)">
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            <Li><strong style={{ color: 'var(--text-dim)' }}>Right to Know</strong> — You may request disclosure of the categories and specific pieces of personal information we have collected about you.</Li>
            <Li><strong style={{ color: 'var(--text-dim)' }}>Right to Delete</strong> — You may request deletion of personal information we have collected, subject to certain exceptions.</Li>
            <Li><strong style={{ color: 'var(--text-dim)' }}>Right to Correct</strong> — You may request correction of inaccurate personal information we maintain about you.</Li>
            <Li><strong style={{ color: 'var(--text-dim)' }}>Right to Opt-Out of Sale / Sharing</strong> — We do not sell your personal information. We do share anonymized website visitor data with Meta and Google for cross-context behavioral advertising (retargeting). California residents have the right to opt out of this sharing. To exercise this right, contact us at <a href="mailto:coach@axistrainingsystems.com" style={{ color: 'var(--text)' }}>coach@axistrainingsystems.com</a> or use the platform opt-out links in Section 4.</Li>
            <Li><strong style={{ color: 'var(--text-dim)' }}>Right to Non-Discrimination</strong> — We will not discriminate against you for exercising any of your privacy rights.</Li>
            <Li><strong style={{ color: 'var(--text-dim)' }}>Right to Limit Use of Sensitive Information</strong> — We only use sensitive personal information (health data, etc.) to provide the coaching services you requested.</Li>
          </ul>
          <p style={{ marginTop: '.75rem' }}>
            To exercise any of these rights, contact us at{' '}
            <a href="mailto:coach@axistrainingsystems.com" style={{ color: 'var(--text)' }}>coach@axistrainingsystems.com</a>.
