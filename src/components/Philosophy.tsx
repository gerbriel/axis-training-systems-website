...
export default function Philosophy() {
  return (
    <section id="philosophy" style={{ background: '#000000', borderTop: '1px solid #0d0d0d', borderBottom: '1px solid #0d0d0d', padding: '8rem 1.5rem' }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Left */}
          <div>
            <p className="label-rule" style={{ color: '#fff', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.35em', textTransform: 'uppercase', marginBottom: '1.5rem' }}>
              Who We Are
            </p>
            ...
            <p style={{ color: '#c7c7c7', fontSize: '.9rem', lineHeight: 1.8, marginBottom: '1.25rem' }}>
            ...
            <p style={{ color: '#c7c7c7', fontSize: '.9rem', lineHeight: 1.8, marginBottom: '2rem' }}>
            ...
            <blockquote style={{ borderLeft: '3px solid #f5b935', paddingLeft: '1.25rem' }}>
              <p style={{ color: '#888888', fontSize: '.875rem', lineHeight: 1.8, fontStyle: 'italic', marginBottom: '.5rem' }}>
              ...
              <p style={{ color: '#fff', fontSize: '.65rem', fontWeight: 900, letterSpacing: '.2em', textTransform: 'uppercase' }}>— Ronnie Vallejo, Founder</p>
            </blockquote>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div className="grid grid-cols-2 gap-4">
              {PILLARS.map(p => (
                <div key={p.num} style={{ background: '#1a1a1a', border: '1px solid #222222', padding: '2rem' }}>
                  <p style={{ color: '#fff', fontSize: '1.75rem', fontWeight: 900, marginBottom: '.75rem' }}>{p.num}</p>
                  <p className="text-white font-bold text-sm mb-2">{p.title}</p>
                  <p style={{ color: '#c7c7c7', fontSize: '.8rem', lineHeight: 1.6 }}>{p.desc}</p>
                </div>
              ))}
            </div>
          </div>
